    ...
    constructor(packager, publishOptions, cancellationToken = packager.cancellationToken) {
        ...
        packager.addAfterPackHandler(async (event) => {
            ...
            if (publishConfig != null) {
                await fs_extra_1.writeFile(path.join(packager.getResourcesDir(event.appOutDir), "app-update.yml"), builder_util_1.serializeToYaml(publishConfig));
            }
        });
