...
async function copyAppFiles(fileSet, packager, transformer) {
    ...
    if (links.length > 0) {
        await bluebird_lst_1.default.map(links, it => fs_extra_1.symlink(it.link, it.file), fs_1.CONCURRENCY);
    }
}
